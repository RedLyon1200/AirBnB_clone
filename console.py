...
class HBNBCommand(cmd.Cmd):
    ...
    def do_destroy(self, arg):
        ...
        Deletes an instance based on the CLASS_NAME and ID
    ...
    def do_update(self, arg):
        ...
        Updates an instance based on the CLASS_NAME and ID by adding or
